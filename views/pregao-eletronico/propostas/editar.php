...
<script type="text/javascript">
    ...
    $(function(){
      $("input[name=cadastrar]").on('click', function(e){
        if( !confirmaDados() ) {
          e.preventDefault();
        }
      });
    ...
    function confirmaDados() 
    {
        ...
        msg += "Antes da abertura da sessão pública do Pregão Eletrônico, certifique-se da entrega de sua proposta e comprove a exatidão dos dados, através da opção Pregão Eletrônico -> Proposta -> Consultar";
